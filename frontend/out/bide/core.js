...
var m__29116__auto__ = (bide.core._navigate[goog.typeOf(x__29115__auto__)]);
if(!((m__29116__auto__ == null))){
return m__29116__auto__.call(null,_,loc,params,query);
} else {
var m__29116__auto____$1 = (bide.core._navigate["_"]);
if(!((m__29116__auto____$1 == null))){
return m__29116__auto____$1.call(null,_,loc,params,query);
} else {
...
var x__29115__auto__ = (((_ == null))?null:_);
var m__29116__auto__ = (bide.core._replace[goog.typeOf(x__29115__auto__)]);
if(!((m__29116__auto__ == null))){
return m__29116__auto__.call(null,_,loc,params,query);
} else {
var m__29116__auto____$1 = (bide.core._replace["_"]);
if(!((m__29116__auto____$1 == null))){
return m__29116__auto____$1.call(null,_,loc,params,query);
} else {
...
var x__29115__auto__ = (((_ == null))?null:_);
var m__29116__auto__ = (bide.core._repr[goog.typeOf(x__29115__auto__)]);
if(!((m__29116__auto__ == null))){
return m__29116__auto__.call(null,_);
} else {
var m__29116__auto____$1 = (bide.core._repr["_"]);
if(!((m__29116__auto____$1 == null))){
...
var vec__39678 = cljs.core.vec.call(null,bide.impl.router.match(router,path));
var name = cljs.core.nth.call(null,vec__39678,(0),null);
var params = cljs.core.nth.call(null,vec__39678,(1),null);
var query = cljs.core.nth.call(null,vec__39678,(2),null);
...
return cljs.core.reduce.call(null,(function (router,p__39681){
var vec__39682 = p__39681;
var path = cljs.core.nth.call(null,vec__39682,(0),null);
var name = cljs.core.nth.call(null,vec__39682,(1),null);
return bide.impl.router.insert(router,path,name);
 ...
 */
bide.core.start_BANG_ = (function bide$core$start_BANG_(router,p__39688){
...
var on_navigate = cljs.core.get.call(null,map__39689__$1,new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908));
var default$ = cljs.core.get.call(null,map__39689__$1,new cljs.core.Keyword(null,"default","default",-1987822328));
var html5_QMARK_ = cljs.core.get.call(null,map__39689__$1,new cljs.core.Keyword(null,"html5?","html5?",-1008298421),false);
var html5history = cljs.core.get.call(null,map__39689__$1,new cljs.core.Keyword(null,"html5history","html5history",-1921478143));
...
var _on_navigate = ((function (default$__$1,map__39689,map__39689__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
return (function bide$core$start_BANG__$__on_navigate(event){
var vec__39694 = _match.call(null,event.token);
var name = cljs.core.nth.call(null,vec__39694,(0),null);
var params = cljs.core.nth.call(null,vec__39694,(1),null);
var query = cljs.core.nth.call(null,vec__39694,(2),null);
return on_navigate.call(null,name,params,query);
});})(default$__$1,map__39689,map__39689__$1,opts,on_navigate,default$,html5_QMARK_,html5history))
;
var _match = ((function (default$__$1,map__39689,map__39689__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
return (function bide$core$start_BANG__$__match(token){
var result = bide.core.match.call(null,router,token);
var or__28432__auto__ = result;
...
;
var _initial_token = ((function (default$__$1,map__39689,map__39689__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
...
var or__28432__auto__ = cljs.core.apply.call(null,bide.core.resolve,router,default$__$1);
if(cljs.core.truth_(or__28432__auto__)){
return or__28432__auto__;
} else {
return "/";
...
var history = (cljs.core.truth_(html5_QMARK_)?(function (){var G__39697 = html5history__$1;
G__39697.setPathPrefix("");

G__39697.setUseFragment(false);

G__39697.setEnabled(true);

return G__39697;
})():(function (){var G__39698 = html5history__$1;
G__39698.setUseFragment(true);

G__39698.setEnabled(true);
...
var x39699 = router;
x39699.close = ((function (x39699,html5history__$1,history,initial_token,initial_loc,lkey,default$__$1,map__39689,map__39689__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
return (function (){
var _ = this;
goog.events.unlistenByKey(lkey);

return history.setEnabled(false);
});})(x39699,html5history__$1,history,initial_token,initial_loc,lkey,default$__$1,map__39689,map__39689__$1,opts,on_navigate,default$,html5_QMARK_,html5history))
;

x39699.bide$core$IRouter$ = cljs.core.PROTOCOL_SENTINEL;

x39699.bide$core$IRouter$_navigate$arity$4 = ((function (x39699,html5history__$1,history,initial_token,initial_loc,lkey,default$__$1,map__39689,map__39689__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
...
x39699.bide$core$IRouter$_replace$arity$4 = ((function (x39699,html5history__$1,history,initial_token,initial_loc,lkey,default$__$1,map__39689,map__39689__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
return (function (_,id,params,query){
var ___$1 = this;
var temp__4657__auto__ = bide.core.resolve.call(null,router,id,params,query);
if(cljs.core.truth_(temp__4657__auto__)){
...
//# sourceMappingURL=core.js.map?rel=1573832740928
