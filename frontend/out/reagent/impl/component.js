...
if((i < len)){
var k = (ks[i]);
var G__30961 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),goog.object.get(o,k));
var G__30962 = (i + (1));
m = G__30961;
i = G__30962;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__30964 = c;
var G__30964__$1 = (((G__30964 == null))?null:G__30964.prototype);
if((G__30964__$1 == null)){
return null;
} else {
return G__30964__$1.reagentRender;
}
})() == null)));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__30966 = c;
var G__30966__$1 = (((G__30966 == null))?null:G__30966.prototype);
if((G__30966__$1 == null)){
return null;
} else {
return G__30966__$1.render;
}
})() == null)));
});
...
while (G__30970__i < G__30970__a.length) {G__30970__a[G__30970__i] = arguments[G__30970__i + 0]; ++G__30970__i;}
  args = new cljs.core.IndexedSeq(G__30970__a,0,null);
} 
...
var args = cljs.core.seq(arglist__30971);
...
var _STAR_current_component_STAR_30973 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_30973;
}});
...
return ((function (G__30974,G__30974__$1){
...
var or__28432__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__30979_30981 = goog.object.get(c,"cljsRatom");
if((G__30979_30981 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__30979_30981);
}
...
if(cljs.core.truth_((function (){var and__28420__auto__ = wrap;
...
var renders_30982 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_30983 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_30982));
...
if((cljs.core.count.call(null,renders_30982) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_30982))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_30983)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_30983))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}


var render_fun = (function (){var or__28432__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__28432__auto__)){
return or__28432__auto__;
} else {
...
var name = (function (){var or__28432__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__28432__auto__)){
return or__28432__auto__;
} else {
var or__28432__auto____$1 = reagent.impl.util.fun_name.call(null,render_fun);
...
var G__30984 = o;
goog.object.set(G__30984,cljs.core.name.call(null,k),v);
...
var name = (function (){var G__30985 = fiber;
var G__30985__$1 = (((G__30985 == null))?null:G__30985.type);
if((G__30985__$1 == null)){
return null;
} else {
return G__30985__$1.displayName;
}
})();
var parent = (function (){var G__30986 = fiber;
if((G__30986 == null)){
return null;
} else {
return G__30986.return;
}
})();
var path = (function (){var G__30987 = parent;
var G__30987__$1 = (((G__30987 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__30987));
if((G__30987__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30987__$1)," > "].join('');
}
})();
...
var temp__4655__auto__ = (function (){var or__28432__auto__ = (function (){var G__30989 = c;
if((G__30989 == null)){
return null;
} else {
return goog.object.get(G__30989,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__28432__auto__)){
return or__28432__auto__;
...
return G__30990._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__28432__auto__ = (function (){var G__30992 = c;
if((G__30992 == null)){
return null;
} else {
return goog.object.get(G__30992,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__28432__auto__)){
return or__28432__auto__;
} else {
var or__28432__auto____$1 = (function (){var G__30994 = c;
if((G__30994 == null)){
return null;
} else {
return G__30994._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__28432__auto____$1)){
return or__28432__auto____$1;
...
var elem = (function (){var or__28432__auto__ = (function (){var G__30996 = instance;
if((G__30996 == null)){
return null;
} else {
return goog.object.get(G__30996,"_currentElement");
}
})();
if(cljs.core.truth_(or__28432__auto__)){
return or__28432__auto__;
} else {
var G__30997 = instance;
if((G__30997 == null)){
return null;
} else {
return G__30997._currentElement;
}
}
})();
var name = (function (){var G__30998 = elem;
var G__30998__$1 = (((G__30998 == null))?null:G__30998.type);
if((G__30998__$1 == null)){
return null;
} else {
return G__30998__$1.displayName;
}
})();
var owner = (function (){var or__28432__auto__ = (function (){var G__31000 = elem;
if((G__31000 == null)){
return null;
} else {
return goog.object.get(G__31000,"_owner");
}
})();
if(cljs.core.truth_(or__28432__auto__)){
return or__28432__auto__;
...
return G__31001._owner;
}
}
})();
var path = (function (){var G__31002 = owner;
var G__31002__$1 = (((G__31002 == null))?null:reagent.impl.component.component_path.call(null,G__31002));
if((G__31002__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__31002__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var n = (function (){var or__28432__auto__ = reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__28432__auto__)){
return or__28432__auto__;
} else {
var G__31003 = c;
var G__31003__$1 = (((G__31003 == null))?null:G__31003.constructor);
if((G__31003__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__31003__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1572992064729
