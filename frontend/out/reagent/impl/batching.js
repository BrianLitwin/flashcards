...
var or__28432__auto__ = w.requestAnimationFrame;
if(cljs.core.truth_(or__28432__auto__)){
return or__28432__auto__;
} else {
var or__28432__auto____$1 = w.webkitRequestAnimationFrame;
if(cljs.core.truth_(or__28432__auto____$1)){
return or__28432__auto____$1;
} else {
var or__28432__auto____$2 = w.mozRequestAnimationFrame;
if(cljs.core.truth_(or__28432__auto____$2)){
return or__28432__auto____$2;
} else {
var or__28432__auto____$3 = w.msRequestAnimationFrame;
if(cljs.core.truth_(or__28432__auto____$3)){
...
var n__29377__auto__ = fs.length;
var i = (0);
while(true){
if((i < n__29377__auto__)){
(fs[i]).call(null);
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__29057__auto__,writer__29058__auto__,opt__29059__auto__){
return cljs.core._write.call(null,writer__29058__auto__,"reagent.impl.batching/RenderQueue");
});
...
//# sourceMappingURL=batching.js.map?rel=1572992064180
