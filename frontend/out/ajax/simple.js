...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__40409){
...
var handler = cljs.core.get.call(null,map__40410__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__28432__auto__ = p1__40412_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__40413){
var map__40414 = p__40413;
var map__40414__$1 = ((((!((map__40414 == null)))?((((map__40414.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40414.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40414):map__40414);
var request = map__40414__$1;
var interceptors = cljs.core.get.call(null,map__40414__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
...
var api = (function (){var or__28432__auto__ = new cljs.core.Keyword(null,"api","api",-899839580).cljs$core$IFn$_invoke$arity$1(request__$1);
if(cljs.core.truth_(or__28432__auto__)){
return or__28432__auto__;
} else {
...
//# sourceMappingURL=simple.js.map?rel=1572995738861
